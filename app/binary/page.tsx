  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <p className="text-muted-foreground font-mono text-sm mb-12">Resume • CV • Full credentials</p>
          ...
          <div className="border border-border rounded-lg p-8 bg-card">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground font-mono">RV College, 2019-2023</div>
              </div>
              <div>
                <div className="text-xs font-mono uppercase text-muted-foreground tracking-widest mb-1">
                  Location
              ...
              <div>
                ...
                <div className="font-mono text-sm">22 core competencies across infrastructure, databases, and observability</div>
              </div>
            </div>
          </div>
        </div>
